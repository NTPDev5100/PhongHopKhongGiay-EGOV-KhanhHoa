...
namespace PhongHopKhongGiay
{
    public class Crypto
    {
        ...
        private const string CRYPT_DEFAULT_PASSWORD = "FPT@QB$ARFX$2015%qaxXSWedcVFRBGTyhnMJUik";
        ...
        public string Encrypt(string inputText)
        {
            ...
            return HttpServerUtility.UrlTokenEncode(GetBytes(Convert.ToBase64String(EncryptDecrypt(inputBytes, true))));
        }
        ...
        public string Decrypt(string inputText)
        {
            try
            {
                inputText = GetString(HttpServerUtility.UrlTokenDecode(inputText));
                //declare a new encoder
                UTF8Encoding UTF8Encoder = new UTF8Encoding();
                //get byte representation of string
        ...
        #region Convert String to Bytes array
