<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChuanBi.ascx.cs" Inherits="PhongHopKhongGiay.Schedule.ThuKy" %>
...
<%--<script src="<%=ResolveUrl("~/DesktopModules/HanhChinhCong/PhongHopKhongGiay/PhongHopKhongGiay/Libary/javascript-ej1-demos/scripts/jsonscheduledata.js") %>" type="text/javascript"></script>--%>
            ...
            <tr id="trKetLuanHop" style="display: none">
                <td>
                    <button id="btnKetLuanHop" style="font-size: large; border-color: white" class="btn btn-default">
                        <i class="fa  fa-file pull-left "></i>&nbsp Kết luận họp
                    </button>
                </td>
            </tr>
            ...
            <tr id="trNoiDungGiaoViec" style="display: none">
                <td>
                    <button id="btnNoiDungGiaoViec" style="font-size: large; border-color: white" class="btn btn-default">
                        <i class="fa fa-user"></i>&nbsp Nội dung giao việc
                    </button>
                </td>
            </tr>
...
<div id="customWindowDanhSachSchedulePhatHanh" style="padding: 1em; display: none;">
    <div id="appointmentWindowDanhSachSchedulePhatHanh" class="appointmentWindow">
        <form id="customAppointmentDanhSachSchedul                            data-page-sizeePhatHanh">
            <br />
            <div class="row">
...
<div id="customWindowVaoHop" style="padding: 1em; display: none;">
    <div id="appointmentWindowVaoHop" class="appointmentWindow">
        ...
        <form id="customAppointmentVaoHop">
            ...
            <div class="container">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#ChuongTrinhHop" data-toggle="tab">Ghi chú</a></li>
...
<div id="customWindowNoiDungGiaoViec" style="padding: 1em; display: none;">
    <div id="appointmentWindowNoiDungGiaoViec" class="appointmentWindow">
        <form id="customAppointmentNoiDungGiaoViec">
            <div class="">
                <ul class="nav nav-tabs">
                    <li id="TabBienBanHop"><a href="#BienBanHopGiaoViec" data-toggle="tab">Kết luận cuộc họp</a></li>
                    <li class="active"><a href="#DanhSachGiaoViec" data-toggle="tab">Danh sách giao việc</a></li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane" id="BienBanHopGiaoViec">
                    ...
                    <div class="tab-pane active" id="DanhSachGiaoViec">
                        <br />
                        <div class="col-md-10">
...
<script type="text/javascript">
    ...
    $("#btnThemDangKyPhatBieu").click(function () {
        ...
        SaveDangKyPhatBieu(0, $("#NoiDungDangKyPhatBieu").val(), false);
    ...
    window.ChucNangNguoiXuLy = {
        'click .Edit': function (e, value, row, index) {
            ...
            if (row.NoiDungKhongPheDuyet != null && row.TinhTrangDuyet == 0) {
                $("#divNoiDungKhongPheDuyet").show();
                $("#NoiDungKhongPheDuyet").val(row.NoiDungKhongPheDuyet);
            }
            else {
                $("#divNoiDungKhongPheDuyet").hide();
                $("#NoiDungKhongPheDuyet").val("");
            }
