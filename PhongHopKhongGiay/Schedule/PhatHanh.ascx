<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PhatHanh.ascx.cs" Inherits="PhongHopKhongGiay.Schedule.PhatHanh" %>
            ...
            <tbody>
                <tr>
                    <td style="width: 459px;">
                        ...
                        <br />
                            - Đ/c Nguyễn Hồ Hải - UVTV – Phó Bí thư Thành ủy;<br />
            ...
            <div class="row" style="margin-left: 50px;">
                <div class="col-md-10">
                    <table id="IDTableNhom"
                        ...
                        <thead>
                            <tr class="headings">
                                <th class="col-md-1" data-align="center" data-field="" data-formatter='stateFormatter' data-checkbox="true"></th>
        ...
        <form id="customAppointmentWindowDetail">
            <div style="margin-left: 42px">
                ...
                <div class="row">
                    ...
                    <%--<div class="col-md-3">
                        <a id="urlChuongTrinhHop">Xem chi chương trình họp</a>
                    </div>--%>
                    <div class="col-md-9">
    ...
    <div id="appointmentWindowShowThemFileDinhkem" class="appointmentWindow">
        <form id="customAppointmentDanhSachShowThemFileDinhkem" style="margin-left: 30px">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <textarea id="TaiLieu_NoiDungShowThemFileDinhkem" name="TaiLieu_NoiDungShowThemFileDinhkem" rows="5" cols="50" style="width: 100%; height: 120px !important; resize: vertical"></textarea>
                </div>
            </div>
            <br />
...
<script type="text/javascript">
    ...
    function OnAppointmentClick(args) {
        ...
        var RoleUser = "PhatHanh";
        $("#RoleUser").val(RoleUser);

        if (args.appointment) {
            if (RoleUser == "PhatHanh") {
...
<script type="text/javascript">
    ...
    $("#btnThemShowThemFileDinhkem").click(function () {
        ...
        var TaiLieu_NoiDungShowThemFileDinhkem = $("#TaiLieu_NoiDungShowThemFileDinhkem").val();
        ...
        var data =
        {
            "obj": {
                ...
                "TaiLieu_NoiDung": TaiLieu_NoiDungShowThemFileDinhkem
            },
            "LichHopID": $("#LichHopID").val(),
            "DoiTuongXemID": 1
        };
            ...
            for (var i = 0; i < data.length; i++) {
                var obj =
                {
                    "obj": {
                        ...
                        "TaiLieu_NoiDung": data[i].TaiLieu_NoiDung
                    },
                    "LichHopID": $("#LichHopID").val(),
                    "DoiTuongXemID": 1
                };
    ...
    window.operateEvents = {
        'click .Edit': function (e, value, row, index) {
            ...
            $("#TaiLieu_NoiDung").val(row.TaiLieu_NoiDung);
            $("#fileSelect").val("");
    ...
    window.operateEventsShowThemFileDinhkem = {
        'click .Edit': function (e, value, row, index) {
            ...
            $("#TaiLieu_NoiDungShowThemFileDinhkem").val(row.TaiLieu_NoiDung);
