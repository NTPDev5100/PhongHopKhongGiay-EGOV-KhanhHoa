...
{
    public partial class PageThanhPhanThamDu : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(PageThanhPhanThamDu));
