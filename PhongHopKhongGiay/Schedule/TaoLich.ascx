<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaoLich.ascx.cs" Inherits="PhongHopKhongGiay.Schedule.TaoLich" %>
...
<div id="PrintSchedule" style="display: none">
    <table style="width: 750px; text-align: left; margin-left: -45px;">
        <tbody>
            <tr>
                <td style="width: 150px; text-align: left">
                    <strong style="text-decoration: underline;">ỦY BAN NHÂN DÂN QUẬN 7</strong>
                </td>
                <td style="width: 50px;"></td>
                <td style="width: 600px; text-align: center">
                    <strong style="text-decoration: none;">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</strong>
                </td>
            </tr>
            <tr>
    ...
    <table style="width: 750px">
        <tbody>
            <tr>
                ...
                <td style="width: 600px; text-align: center">
                    <strong>&nbsp; LỊCH LÀM VIỆC CỦA THƯỜNG TRỰC</strong><br>
                    <strong>QUẬN ỦY - HỘI ĐỒNG NHÂN DÂN - ỦY BAN NHÂN DÂN QUẬN 7</strong>
                </td>
                <td></td>
            </tr>
            <tr>
            ...
            <tbody>
                <tr>
                    <td style="width: 459px;">
                        ...
                        <br />
                            - Đ/c Nguyễn Hồ Hải - UVTV – Trưởng Ban Tổ chức Thành ủy;<br />
                            - Đ/c Hà Minh Hiền - Phó trưởng phòng địa bàn 01 Ủy Ban Kiểm tra Thành ủy;<br />
                            - Đ/c Trương Văn Lắm-UVUBNDTP–Giám đốc Sở Nội vụ;<br />
           ...
           <div id="TinhTrangColor">
                <div data-toggle="buttons">
                    <label class="btn btn-warning active btn-sm" onclick="LoadScheduleByColorStatus('DangTao')">
                        <input type="checkbox" id="DangTao" value="DangTao" autocomplete="off" checked>
                    ...
                    <label class="btn btn-danger active btn-sm" onclick="LoadScheduleByColorStatus('ChoDuyet')">
                        <input type="checkbox" id="ChoDuyet" value="ChoDuyet" autocomplete="off" checked>
                    ...
                    <label class="btn btn-info active btn-sm" onclick="LoadScheduleByColorStatus('KhongPheDuyet')" style="color: #fff; background-color: #804000; border-color: #804000;">
                        <input type="checkbox" id="KhongPheDuyet" value="KhongPheDuyet" autocomplete="off" checked>
                        <span class="glyphicon glyphicon-ok"></span>
                    </label>
                    Không phê duyệt&nbsp
                    <label class="btn btn-primary active  btn-sm" onclick="LoadScheduleByColorStatus('DaDuyet')">
                        <input type="checkbox" id="DaDuyet" value="DaDuyet" autocomplete="off" checked>
                        <span class="glyphicon glyphicon-ok"></span>
                    </label>
                    Đã duyệt&nbsp

                    <label class="btn btn-success active btn-sm" onclick="LoadScheduleByColorStatus('DaPhatHanh')">
                        <input type="checkbox" id="DaPhatHanh" value="DaPhatHanh" autocomplete="off" checked>
                        <span class="glyphicon glyphicon-ok"></span>
                    </label>
                    Đã phát hành&nbsp
                    <label class="btn btn-default active btn-sm" onclick="LoadScheduleByColorStatus('HuyHop')" style="color: #fff; background-color: dimgrey; border-color: dimgrey;">
                        <input type="checkbox" id="HuyHop" value="HuyHop" autocomplete="off" checked>
                        <span class="glyphicon glyphicon-ok"></span>
                    </label>
                    Hủy họp&nbsp
                        <label class="btn btn-default active btn-sm" onclick="LoadScheduleByColorStatus('TrungLich')">
                        <input type="checkbox" id="TrungLich" value="TrungLich" autocomplete="off" checked>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="file" id="fileSelect" onchange="checkfile(this)" accept="xlsx, xls, doc, docx, pdf, pptx" />
        ...
        <form id="customAppointmentWindowTaoLuong">
            ...
            <div class="row" style="margin-left: 50px;">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" id="btnChonTaoLuong" class="btn btn-default"><i class="fa fa-check"></i>&nbsp Chọn</button>
        ...
        <form id="customAppointmentPhatHanhLichHop">
            <div class="row">
                ...
                <div class="col-md-11 e-textlabel" style="font-size: large">
                    LỊCH LÀM VIỆC CỦA THƯỜNG TRỰC QUẬN ỦY - HỘI ĐỒNG NHÂN DÂN - ỦY BAN NHÂN DÂN QUẬN 7
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function OnResizeStop(args) {
        ...
        $.ajax({
            ...
            dataType: "json",
            async: false,
            success: function (reponse) { if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; } if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; }
                if (reponse.d) {
    ...
    function OnAppointmentClick(args) {
        ...
        if (args.appointment) {
            if (RoleUser == "QuanLy") {
                ...
                if (UserLoginSchedule != args.appointment.CreatedUserID) {
...
<script type="text/javascript">
    ...
    var comboChuanBiID, comboThanhPhanID, comboDoiTuongNhacID, comboThanhPhanDonViKhac,
        ...
        comboLyDoVangID, comboThoiGianNhacLichHop, SelectParentChuTri,
        SelectParentThuKy, dataMapSchedule, SelectParentPhongHop, UserLoginSchedule, TinhTrangColor
        ...
        $.ajax({
            ...
            success: function (reponse) { if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; } if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; }
                ...
                if (DataPhatHanh && DataPhatHanh.length > 0) {
                    ...
                    elm.type = 'week'
                    elm.valueAsDate = new Date(TuNgay)
                    var week = elm.value.split('W').pop();

                    $("#lblTuanXemLichHopPhatHanh").text(week);
            ...
            $.ajax({
                ...
                success: function (reponse) { if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; } if (reponse.d === null) { alert_warning("Bạn đã hết thời gian đăng nhập, Vui lòng thoát ra đăng nhập lại hệ thống !"); return; }
                    ...
                    if (data.Table1.length > 0) {
                        divTable += '<table style="border:3px solid black;margin-left: -60px;" cellspacing="0" cellpadding="0" width="750px">'
                        divTable += '<tbody>'
                        divTable += '<tr>'
                        divTable += '<td width="100" colspan="2" style="text-align:center; border: 1px solid black; border-bottom: 3px solid black; border-right:3px solid black;padding: 6px;">'
                        divTable += '<p><strong>Ngày</strong></p>'
                        divTable += '</td>'
                        divTable += '<td width="50" style="text-align: center;  border: 1px solid black; border-bottom: 3px solid black; border-right:3px solid black;padding: 6px;">'
                        divTable += '<p><strong>Giờ</strong></p>'
                        divTable += '</td>'
                        divTable += '<td width="100" style="text-align: center;  border: 1px solid black; border-bottom: 3px solid black; border-right:3px solid black;padding: 6px;">'
                        divTable += '<p><strong>Chủ trì</strong></p>'
                        divTable += '</td>'
                        divTable += '<td width="200" style="text-align: center;  border: 1px solid black; border-bottom: 3px solid black; border-right:3px solid black;padding: 6px;">'
                        ...
                        divTable += ' </td>'
                        divTable += '<td width="200" style="text-align: center;  border: 1px solid black; border-bottom: 3px solid black;border-right:3px solid black;padding: 6px;">'
                        divTable += '<p><strong>Thành phần</strong></p>'
                        divTable += '</td>'
                        divTable += '<td width="100" style="text-align: center;  border: 1px solid black; border-bottom: 3px solid black;border-right:3px solid black;padding: 6px;">'
                                ...
                                if (dataBuoi.length > 0) {
                                    ...
                                    for (var j = 0; j < dataBuoi.length; j++) {
                                        ...
                                        if (replaceAll(dataBuoi[j].ChuanBi, map) != "" && dataBuoi[j].ChuanBiKhac != "") {
                                            ChuanBi = replaceAll(dataBuoi[j].ChuanBi, map) + "," + dataBuoi[j].ChuanBiKhac;
                                        }

                                        if (replaceAll(dataBuoi[j].ChuanBi, map) == "" && dataBuoi[j].ChuanBiKhac != "") {
                                            ChuanBi = dataBuoi[j].ChuanBiKhac;
                                        }
                                        if (replaceAll(dataBuoi[j].ChuanBi, map) != "" && dataBuoi[j].ChuanBiKhac == "") {
                                            ChuanBi = replaceAll(dataBuoi[j].ChuanBi, map);
                                        }
                                        if (j == 0) {
                                            ...
                                            divTable += replaceAll(dataBuoi[j].ChuTri, map) ;
                                            divTable += '</td>'
                                            divTable += '<td width="200" style="font-size: 12px; border: 1px solid black; padding: 3px;">'
                                            divTable += dataBuoi[j].NoiDung;
                                            divTable += '</td>'
                                            divTable += '<td width="100" style="font-size: 12px; border: 1px solid black; padding: 3px;">'
                                            divTable += ChuanBi;
                                            divTable += '</td>'
                                            divTable += '<td width="200" style="font-size: 12px; border: 1px solid black; padding: 3px;">'
                                            divTable += replaceAll(dataBuoi[j].ThanhPhan, map);
                                            divTable += '</td>'
                                            if (dataBuoi.length > 1) {
                                                for (var m = 0; m < dataBuoi.length; m++) {
                                                    if (dataBuoi[j].ChuTri == dataBuoi[m].ChuTri && dataBuoi[j].DiaDiem == dataBuoi[m].DiaDiem) {
    ...
    $("#btnChuyenDuyetTatCa").click(function () {
        ...
        var LichHopDangTao = dataMapSchedule.filter(x => x.Categorize == 1 && x.CreatedUserID == UserLoginSchedule)// đang tạo
                    ...
                    if (ChuoiNguoiChuTriID.length > 0 && ChuoiNguoiChuTriID[0].ChuoiNguoiChuTriID != "") {
                        ...
                        for (var i = 0; i < splitChuoiNguoiChuTriID.length; i++) {
                            ...
                            if (IsExistNguoiChuTriTrongThanhPhan.length > 0) {
                                alert_warning("Hiện tại chủ trì " + SelectParentChuTri.filter(x => x.UserID == IsExistNguoiChuTriTrongThanhPhan.UserID)[0].title + " này đang điều hành cuộc họp. Xin vui lòng bỏ chọn ra khỏi thành phần họp")
                                break;
                            }
                        }
                        if (IsExistNguoiChuTriTrongThanhPhan.length > 0) {
    ...
    $("#btnHuyLichHopMulti").click(function () {
        var data = $("#IDTableDanhSachSchedulePhatHanh").bootstrapTable('getAllSelections')
        if (data.length > 0) {
            var DuLieuCuaUserKhac = data.filter(x => x, CreatedUserID != UserLoginSchedule);
            if (DuLieuCuaUserKhac.length > 0) {
                alert_warning("Bạn không được hủy lịch họp của người khác. Xin vui lòng chọn lại lịch họp của mình");
                return;
            }
    ...
    function PhatHanhTrucTiep() {
        ...
        var dataPhatHanh =
        {
            "obj": {
                ...
                "ThoiGianTu": TuNgay,
                "ThoiGianDen": DenNgay,
                "NoiDung": $("#NoiDungPhatHanh").summernote("code"),
                "LichHopPhatHanhID": $("#LichHopPhatHanhID").val(),
                "TenFile": TenFile,
                "FileID": FileID,
    ...
    $("#btnLuuPhatHanh").click(function () {
        ...
        EmailNhanThongBao = EmailNhanThongBao + "," + Email.slice(0, -1);
        var dataPhatHanh =
        {
            "obj": {
                "PhatHanhID": PhatHanhID,
